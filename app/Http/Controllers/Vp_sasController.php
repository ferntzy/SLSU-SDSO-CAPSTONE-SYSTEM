...
class Vp_sasController extends Controller
{
  ...
  {
    $pendingReviews = EventApprovalFlow::where('approver_role', 'VP_SAS')
    ...
    return view('vpsas.dashboard', compact('pendingReviews', 'approved', 'rejected'));
  }
  ...
  public function pending()
  {
   $pendingReviews = EventApprovalFlow::with(['permit.organization'])
    ...
    return view('vpsas.events.pending', compact('pendingReviews'));
  }
  ...
  public function approved()
  {
    ...
    return view('vpsas.events.approved', compact('approvedReviews'));
  }
  ...
  public function rejected()
  {
    ...
    return view('vpsas.events.rejected', compact('rejectedReviews'));
  }
  ...
  public function history()
  {
    ...
    return view('vpsas.events.history', compact('historyReviews'));
  }
  ...
  public function approve(Request $request, $approval_id)
{
    ...
    // Security check
    if ($flow->approver_role !== 'VP_SAS' || $flow->status !== 'pending') {
    ...
    // Save signed PDF
    $signedPath = $tempDir . "/vpsas_signed_{$permit->hashed_id}.pdf";
  ...
  public function reject(Request $request, $approval_id)
  {
    ...
    $flow->update([
      ...
      'approver_id' => Auth::id(),
      'approver_name' => strtoupper(Auth::user()->name ?? 'VP_SAS'),
      'updated_at' => now(),
    ]);
