    ...
    <div class="modal-dialog modal-m modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body p-0">
              <form id = "frmAddOfficer">
                <div class="overflow-auto p-3" style="max-height: 70vh;">
                  <div class="row g-3">

                      <input type="hidden" id="officerOrgID" value="" name = "officerOrgID">
                      ...
                      @foreach($roles as $position)
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                              ...
                              <select class="form-select officer-select" name="officers[]" data-role="{{ $position->RoleName }}">
                                <option value="">Select</option>
                                @foreach($students as $student)
                                    <option value="{{ $student->profile_id }}|{{$position->id}}">
